...
\usepackage{csquotes}
\usepackage[style=chem-acs, backend=biber, articletitle=true, chaptertitle=true,doi=true]{biblatex}
...
\setcounter{secnumdepth}{3} % Limit numbering to subsubsections
\setcounter{tocdepth}{3} % Show levels down to subsubsection in ToC
...
\begin{titlepage}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        {\fontsize{32}{40}\selectfont \color{USCBlue} Daniel\\ Conde Torres\\[0.5cm] \fontsize{16}{20}\selectfont};
        ...
        {\fontsize{12}{14}\selectfont \color{white} Santiago de Compostela, 2026};
